...
function validateForm(username_list, email_list, userName, userEmail){
    ...
    for (i = 0; i < username_list.length; i++) {
        if(username_list[i] == userName) continue;
        else if(username_list[i] == username){
    ...
    for (i = 0; i < email_list.length; i++) {
        if(email_list[i] == userEmail) continue;
        else if(email_list[i] == user_email){
